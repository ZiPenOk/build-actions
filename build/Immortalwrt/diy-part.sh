...
export Op_name="OpenWrt-ZiPen"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 默认主题设置
export Mandatory_theme="kucat"              # 将bootstrap替换您需要的主题为必选主题(可自行更改您要的,源码要带此主题就行,填写名称也要写对) (填写主题名称,填0为不作修改)
